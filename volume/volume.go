...
func (m *MountPoint) Setup(mountLabel string, rootIdentity idtools.Identity, checkFun func(m *MountPoint) error) (path string, err error) {
	defer func() {
	...
	if m.Type == mounttypes.TypeBind {
		...
		if err := idtools.MkdirAllAndChownNew(m.Source, 0755, rootIdentity.IdPair); err != nil {
